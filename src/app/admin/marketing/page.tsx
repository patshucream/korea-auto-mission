...
const labels: Record<string,string> = { naver_mission:"네이버 광고 · 미션",naver_diesel:"네이버 광고 · 디젤",naver_other:"네이버 광고 · 기타",naver:"네이버 일반 유입",google:"구글",direct:"직접 방문·확인 불가",other:"기타",home:"홈",mission:"미션수리 안내",diesel:"디젤 클리닝 안내",works:"작업사례 목록",work:"작업사례 글" };
