    ...
    if (supabase) {
      ...
      if (data) {
        settings = {
          ...
          ...data,
          weekday_hours:
            (typeof data.weekday_hours === "string" && data.weekday_hours) ||
            DEFAULT_SETTINGS.weekday_hours,
          saturday_hours:
            (typeof data.saturday_hours === "string" && data.saturday_hours) ||
            DEFAULT_SETTINGS.saturday_hours,
          holiday_hours:
            (typeof data.holiday_hours === "string" && data.holiday_hours) ||
            DEFAULT_SETTINGS.holiday_hours,
          process_steps: data.process_steps || DEFAULT_SETTINGS.process_steps,
        };
      }
    } else {
